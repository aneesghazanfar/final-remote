...
<head>
    ...
    <title>IT Support and Maintenance Services &mdash; SSEDLAB</title>
    ...
    <style>
        .banner-img-page {
            ...
            url('https://itrexgroup.com/wp-content/uploads/2022/05/iStock-1370474836-min.jpg');
...
<body id="page-index">
    ...
    <div class="body-wrap-1">
        ...
        <div class="top_section-1 vis_on_scroll ">
            ...
            <div class="container-header">
                    ...
                    <p class="tt-banner-para">
                        Create a positive user experience, upgrade your apps on the go, and extend the lifetime of your
                        IT infrastructure with full-scale IT support and maintenance services
                    </p>
                    <section class="banner-btn">
                        <button class="tt-banner-btn">Request support</button>
        ...
        <section class="mb-sec-2">
            ...
            <h2 class="mb-text-white">We offer three tiers of application support and maintenance
            </h2>
                <p>
                    If you’re looking to maintain, modernize, update, or secure your applications and IT infrastructure, SSED has got you covered. We are skilled. We are experienced. We are well-versed in providing full-scale support and know-how to make your tech infrastructure drive business success. To do so, we offer three tiers of support:
                </p>
                <div class="mb-row mb-sec-2-2">
                    <div class="mb-sec-2-inner-col">
                        ...
                        <p class="sec-2-device-p">
                            We’ll help you sort out the issues related to network performance and application stability. Our level 1 support services span:
                        </p>
                        <p class="sec-2-device-p">
                            <span>◉</span>  Basic support and troubleshooting

                        </p>
                        <p class="sec-2-device-p">
                            <span>◉</span> System availability and performance monitoring

                        </p>
                        <p class="sec-2-device-p">
                            <span>◉</span> Back-office activities, such as modifying accounts, resetting passwords, and communicating with end-users
                    ...
                    <div class="mb-sec-2-inner-col">
                        ...
                        <p class="sec-2-device-p">
                            Our level 2 support engineers will help you restore your apps and resolve incidents of medium complexity, providing the following services:
                        </p>
                        <p class="sec-2-device-p">
                            <span>◉</span> Advanced troubleshooting
                        ...
                        <p class="sec-2-device-p">
                            <span>◉</span> Configuration management and deployment
                        </p>
                        <p class="sec-2-device-p">
                    ...
                    <div class="mb-sec-2-inner-col">
                        ...
                        <p class="sec-2-device-p">
                            SSED’s experienced development team will help you deal with the most complex technical problems, carrying out:
                        </p>
                        <p class="sec-2-device-p">
                            <span>◉</span>  Bug fixing and root cause analysis

                        </p>
                        <p class="sec-2-device-p">
                            <span>◉</span> Audits and code reviews
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> <span class="mb-orange">IT support & maintenance
                    </span><br>
                    services for flawless operations
                </h2>
                <p>
                    We deliver not only support and maintenance services but take care of every aspect of your IT infrastructure and apps, making sure they are stable, scalable, high-performing, and bug-free. For that, we offer a broad range of activities, spanning:
        ...
        <section class="mb-sec-2">
            <div class="mb-sec-2-inner">
                <div class="mb-row mb-sec-2-2">
                    <div class="mb-sec-2-inner-col">
                        ...
                        <p class="sec-2-device-p">
                            We will gather and analyze performance data from servers, databases, and other essential components of your infrastructure to make sure it runs without a hitch
                    ...
                    <div class="mb-sec-2-inner-col">
                        ...
                        <p class="sec-2-device-p">
                            We will identify, gather, and analyze the appropriate performance metrics, dig the root causes of performance issues, as well as devise and implement the necessary performance optimization tactics.
            ...
            <section class="banner-btn mb-mt-50">
                <button class="tt-banner-btn">Guard your tech infrastructure</button>
                <img src=" {{asset('img/SVG.svg') }}" alt="">
            </section>
        </section>
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> <span class="mb-orange">The components of IT
                    </span><br>
            ...
            <div class="mb-icon-text-row-main">
                <div class="mb-icon-text-col-main">
                    <div class="mb-icon-text-row">
                        <div class="mb-icon-text-col mb-icon-text-right">On-premises servers
                        </div>
                    </div>
                    <div class="mb-icon-text-row">
                        <div class="mb-icon-text-col mb-icon-text-right">Networks</div>
                    </div>
                    <div class="mb-icon-text-row">
                        <div class="mb-icon-text-col mb-icon-text-right">Cloud servers
                        </div>
                    </div>
                </div>
                <div class="mb-icon-text-col-main">
                    ...
                    <div class="mb-icon-text-row">
                        <div class="mb-icon-text-col mb-icon-text-right">Websites and web portals</div>
                    </div>
                </div>
            </div>
        ...
        <section class="mb-container sec-3">
        <div class="delievery-industry-spec">
            <h2> <span class="mb-orange">SSED: a worthy support
                </span><br>
        ...
        <div class="mb-sec-2-inner">
            ...
            <div class="mb-row mb-sec-2-2">
                <div class="mb-sec-2-inner-col">
                    ...
                    <p class="sec-2-device-p">
                        We aren’t tied to any providers, so we make it a priority to find the most suitable data
                        engineering and data analytics technologies to meet your needs.
                ...
                <div class="mb-sec-2-inner-col">
                    ...
                    <p class="sec-2-device-p">
                        Before diving into your project and actually delivering support and maintenance, we set clear service level objectives and determine measurable KPIs that guarantee the high quality of the delivered services
                    </p>
            ...
            <div class="mb-row mb-sec-2-2">
                <div class="mb-sec-2-inner-col">
                    ...
                    <p class="sec-2-device-p">
                        With our 300+ strong team, we bring in data scientists, senior data analysts, elite developers,
                        and our R&D department, delivering top results since 2009. </p>
                ...
                <div class="mb-sec-2-inner-col">
                    ...
                    <p class="sec-2-device-p">
                        We scale support teams according to the complexity of your project and offer a variety of engagement models that can be further adjusted to your specific business needs.
                    </p>
