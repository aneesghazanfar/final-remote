...
<head>
    ...
    <title>UI/UX Development Services &mdash; SSEDLAB</title>
    ...
    <div class="body-wrap-1">
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> <span class="mb-orange">What our UI/UX design company
                    </span><br>
                    does best
                </h2>
                <p>
...
.
            ...
            <section class="banner-btn mb-mt-50">
                <button class="tt-banner-btn">Discuss your UI/UX design needs</button>
                <img src=" {{asset('img/SVG.svg') }}" alt="">
            </section>
        </section>
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> <span class="mb-orange">How we deliver our
                    </span><br>
        ...
        <section class="mb-container sec-3 mb-container-padding">
            ...
            <div class="section__button" style="margin-top: 40px;"><a class="button button--orange" href="#">
                    <span class="button__wrap"><span class="button__inner_wrap">
                            <b class="button__inner_text">Hire UI/UX designers </b>
                        </span>
                        ...
                        <div class="swiper-slide">
                            <div class="mb-position-relative mb-overlay-carousel">
                                <a href="/cdn-cgi/l/email-protection"><img src=" {{asset('img/wallmart_1.jpg') }}"
                                        alt="Swiper">
                                    <h3 class="slider-heading">Social app→</h3>
                                    <p>
    ...
    <section class="mb-container sec-3">
        <div class="delievery-industry-spec">
            <h2> <span class="mb-orange">Why work with our
                </span><br>
