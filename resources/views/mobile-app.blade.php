    ...
    <div class="body-wrap-1">
            ...
            <div class="top_section vis_on_scroll banner-img-mobile">
                <div class="container">
                    ...
                    <p class="tt-banner-para">
                        We create custom mobile Apps that beat business challenges, generate revenue and hit millions of
                        downloads
                    ...
                    <section class="banner-btn">
                        <button class="tt-banner-btn">Hire App Developer</button>
        ...
        <section class="mb-sec-2">
            <div class="mb-sec-2-inner">
                <h2 class="mb-text-white">Custom app solutions for any mobile platform</h2>
                <p>
                    ...
                    <div class="mb-sec-2-inner-col">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="57" viewBox="0 0 47 57" fill="none">
                            <g clip-path="url(#clip0_199_4797)">
                                <mask id="mask0_199_4797" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                                    y="0" width="47" height="57">
                            ...
                            <defs>
                                <clipPath id="clip0_199_4797">
                                    <rect width="45.91" height="55.9878" fill="white"
                                        transform="translate(0.5 0.805664)" />
                                </clipPath>
                            </defs>
                        </svg>
                    ...
                    <div class="mb-sec-2-inner-col">
                        <svg xmlns="http://www.w3.org/2000/svg" width="49" height="57" viewBox="0 0 49 57" fill="none">
                            <g clip-path="url(#clip0_199_4813)">
                                <mask id="mask0_199_4813" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                                    y="0" width="48" height="57">
                            ...
                            <defs>
                                <clipPath id="clip0_199_4813">
                                    <rect width="48.16" height="56" fill="white"
                                        transform="translate(0.163086 0.799805)" />
                                </clipPath>
                            </defs>
                        </svg>
                        <h3 class="sec-2-device">
                ...
                <br><br><br>
                <section class="banner-btn">
                    <button class="tt-banner-btn">Let's Build An App</button>
                    <img src=" {{asset('img/SVG.svg') }}" alt="">
                </section>
            </div>
        </section>
