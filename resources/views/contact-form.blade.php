                  ...
                  <div class="demo_request__form form_page__wrap">
                      <div class="form_page">
                          <div class="demo_request__head">
                              Contact us</div>
                          <div class="demo_request__descr demo_request__descr--gate">We will process your personal
                              information in accordance with our <span style="color: orange;">Privacy Policy.</span>
                          </div>
                          <form class="form demo_request_form contact-form" action="api/v1/auth/token/master-session">
                              <div class="form-label">
                                  <div class="label-1">
                                      <label class="form__input field">
                                          <input type="text" name="login" data-valid="false" data-name="login"
                                              placeholder="Login">
                                  ...
                                  <div class="label-2">
                                      ...
                                      <label class="form__input field">
                                          <input type="text" name="message" data-valid="false" data-name="password"
                                              placeholder="Password">
                                      ...
                                      <label class="form__check field forrm-checkbox">
                                          ...
                                          <div class="">We will process your personal information in accordance with our
                                              Privacy Policy.</div>
                                      </label>
                              ...
                              <div class="form__submit">
                                  <button class="disabled button button--orange"><span class="button__wrap"><span
                                              class="button__inner_wrap"><b class="button__inner_text">Send
                                                  Message</b></span><span class="button__arrow">
