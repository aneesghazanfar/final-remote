    ...
    <div class="body-wrap-1">
            ...
            <div class="top_section vis_on_scroll banner-img-soft">
                <div class="container">
                    ...
                    <p class="tt-banner-para">
                        Our software quality assurance and testing services enable you to deliver fast with confidence
                        that your systems and products perform flawlessly
                    </p>
        ...
        <section class="services-sec container">
            ...
            <div class="ss-main-section">
                ...
                <p class="ss-sevices-para">We help you define standards and processes for creating a robust culture of
                    quality in which striving for perfection is built by design into your development process. Take your
                    mind off expensive mistakes - we will take care of them, saving your team’s time and cutting project
                    bills.
                </p>
        ...
        <section class="mb-sec-2 mb-mt-50">
            <div class="mb-logo-title"> <b>Manual testing toolkit</b>
            </div>
            <div class="mb-flex">
            ...
            <br>
            <div class="mb-logo-title"> <b>Automation testing toolkit</b>
            </div>
            <div class="mb-flex">
                <div class="mb-logo-list">
