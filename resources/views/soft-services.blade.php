    ...
    <div class="body-wrap-1">
        ...
        <section class="services-sec container">
            ...
            <div class="ss-main-section">
                ...
                <p class="ss-sevices-para">We offer a whole gamut of software engineering and consulting services to
                    help our
                    clients create technology systems for enterprise resource planning, collaboration, customer
                    management, data
                ...
                <div class="row-box d-flex jc al">
                    <div class="col4 pr48">
                        ...
                        <p class="ss-services-box-para">Technology consulting is the cornerstone of our software engineering
                             services package. We’ll assess your business requirements, review your existing IT infrastructure, 
                            propose a suitable tech, and create a proof of concept to assess the feasibility of your idea.</p>
                    </div>
                    <div class="col4 pr48">
                        <div class="text-center">
                        ...
                        <p class="ss-services-box-para">Whether you need a mobile app with a powerful cloud back end, a dynamic web app, embedded software for a Smart Home device, or an advanced analytics platform to crunch your Big Data, our software engineering company is here at your service!
                        </p>
                    </div>
                    <div class="col4">
                        <div class="text-center">
                        ...
                        <p class="ss-services-box-para">Drawing on the insights uncovered during the project discovery phase, 
                            our software architects join forces with skilled business analysts to design a resilient software
                             architecture that will scale flexibly along with your business and leave room for innovation.
                        </p>
                    </div>
                    <div class="col4 pr48">
                        <div class="text-center">
                        ...
                        <p class="ss-services-box-para">Besides custom software engineering, we migrate legacy
                            applications to a modern tech stack, segment bulky software into microservices, orchestrate
                            containerized apps with Kubernetes, and interconnect the components of your IT
                            infrastructure.</p>
                    </div>
                </div>
                ...
                <div class="row-box d-flex jc al">
                    <div class="col4 pr48">
                        ...
                        <p class="ss-services-box-para">The SSED software engineering service team will
                             follow DevOps best practices to set up a complete cloud infrastructure for your
                              software solution, ensure faster updates,
                             and monitor application performance. We offer three tiers of support, too.
                    ...
                    <div class="col4 pr48">
                        ...
                        <p class="ss-services-box-para">From auditing your customers’ buying
                             journey to applying data democratization principles in data analytics dashboard design,
                              our software engineering company always creates navigation logic
                             and interfaces that allow users to perform intended actions with minimal friction.</p>
                    </div>
                    <div class="col4 pr48">
                        <div class="text-center">
                        ...
                        <p class="ss-services-box-para">As part of our software product engineering services, 
                            we turn to manual testing and write scripts for automated tests to validate that your applications 
                            contain zero bugs, perform as expected, and deliver unsurpassed user experience.</p>
                    </div>
                    <div class="col4">
                        <div class="text-center">
                        ...
                        <p class="ss-services-box-para">We provide innovative software engineering services 
                            to tech startups and enterprises undergoing digital transformation. If you’re looking 
                            to add RPA bots to your accounting software or
                             build an IoT-powered fitness mirror from the ground up, just drop us a line!</p>
                    </div>
                </div>
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> <span class="mb-orange">Software engineering</span> solutions in <br>
                    focus</h2>
                <p>
                    Our software engineering company collaborates with businesses from the healthcare, finance,
                    education,
                    retail, supply chain management, and other verticals. We help our clients test the novel technology
                    waters, scale IT systems company wide, and ensure faster paybacks. Our core software engineering
                ...
                <div class="row-box d-flex jc al">
                    <div class="col4 pr48">
                        <div class="text-center">
                            ...
                            <img class="m-auto" src="https://itrexgroup.com/wp-content/uploads/2021/11/accord_4-1.gif" alt="">
                        </div>
                        <h3 class="ss-servies-box-heading">
                            Enterprise Technology
                        </h3>
                        <p class="ss-services-box-para">The SSED software product engineering firm is well-versed in 
                            enterprise IT technologies. ERP systems, CRM and help desk solutions, document and learning management
                             systems, HRM and project management software,
                             accounting and eProcurement tools — you can find it all in our portfolio.</p>
                    </div>
                    <div class="col4 pr48">
                        <div class="text-center">

                            <img class="m-auto" src="https://itrexgroup.com/wp-content/uploads/2021/11/accord_1-1.gif" alt="">
                        </div>
                        <h3 class="ss-servies-box-heading">
                            Artificial Intelligence
                        </h3>
                        <p class="ss-services-box-para">We take pride in our AI expertise and offer a wide range of 
                            innovative software engineering services to supercharge your technology systems. Partner
                             with SSED to develop apps with computer vision capabilities,
                             train highly accurate machine learning models, and reduce bias in custom AI deployments.
                        </p>
                    </div>
                    <div class="col4">
                        <div class="text-center">

                            <img class="m-auto" src="https://itrexgroup.com/wp-content/uploads/2021/11/accord_6-2.gif" alt="">
                        </div>
                        <h3 class="ss-servies-box-heading">
                            Automation
                        </h3>
                        <p class="ss-services-box-para">Rule-based business process automation tools, lightweight RPA bots interacting with application interfaces, and AI algorithms automating processes based on historical and real-time data — we’ve been there, done that. Tap into our software engineering services to boost employee productivity and cut operational costs!</p>
                    </div>
                </div>
                ...
                <div class="row-box d-flex jc al">
                    <div class="col4 pr48">
                        <div class="text-center">
                            ...
                            <img class="m-auto" src="https://itrexgroup.com/wp-content/uploads/2021/11/accord_3-2.gif" alt="">
                        </div>
                        <h3 class="ss-servies-box-heading">
                            Big Data Analytics
                        </h3>
                        <p class="ss-services-box-para">SSED Group is a software engineering company with a strong background
                             in data science. Do you need help customizing SaaS business intelligence (BI) products to best suit
                              your analytics? Are you struggling to interpret unstructured data or ensure an uninterrupted flow 
                              of information across your IT infrastructure? 
                            Whatever your objectives are, we’ve got you covered!</p>
                    </div>
                    <div class="col4 pr48">
                        <div class="text-center">

                            <img class="m-auto" src="https://itrexgroup.com/wp-content/uploads/2021/11/accord_2-2.gif" alt="">
                        </div>
                        <h3 class="ss-servies-box-heading">
                            Internet of Everything
                        </h3>
                        <p class="ss-services-box-para">To help you further boost your data analytics and automation efforts, we transform your assets, equipment, and even personnel into a wealth of data. For this, we design and implement smart sensors, embedded systems, cloud-based data storage and processing solutions, and rich user interfaces, which range from mobile apps to built-in voice assistants.</p>
                    </div>
                    <div class="col4">
                        <div class="text-center">

                            <img class="m-auto" src="https://itrexgroup.com/wp-content/uploads/2021/11/accord_5-2.gif" alt="">
                        </div>
                        <h3 class="ss-servies-box-heading">
                            Metaverses
                        </h3>
                        <p class="ss-services-box-para">We draw on our extended reality and blockchain development
                             expertise to create metaverse apps of all sizes and levels of complexity. Whether you
                              need an augmented reality app with Snapchat-like filters or a marketplace to trade NFTs,
                             we’re the right software engineering firm to undertake your project!</p>
                    </div>
                </div>
                <section class="banner-btn pt64">
                    <button class="tt-banner-btn">Discuss your software engineering needs</button>
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> <span class="mb-orange">Software engineering services delivered</span> how and when you need them <br>
                    </h2>
                <p>
                    As an IT firm that went all the way from a software engineering outsourcing company to a technology vendor
                     with niche expertise, SSED offers flexible engagement models to meet your requirements:
                </p>
            </div>
        </section>
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> <span class="mb-orange">Our software engineering</span> company at a glance <br>
                    </h2>
                <p>
                    Our software engineering company collaborates with businesses from the healthcare, finance,
                    education,
        ...
        <section class="mb-sec-2 mb-mt-50">
            ...
            <div class="divlanding-list-list">
                ...
                </div> <div class="divlanding-list-list">
                    <div class="divlanding-list-col">
                        <div class="divlanding-list-item">
                            <div class="divlanding-list-item-icon"></div>
                            <div class="divlanding-list-item-text">
