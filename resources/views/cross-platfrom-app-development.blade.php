...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no, viewport-fit=cover">
        <title>Cross-Platform App Development Services &mdash;   SSEDLAB</title>
    ...
    <div class="body-wrap-1">
        ...
        <div class="top_section-1 vis_on_scroll ">
            ...
            <div class="container-header">
                    ...
                    <p class="tt-banner-para">
                        Our skilled team crafts feature-rich apps that work flawlessly across different mobile platforms and boast native-like performance and user experience
                    </p>


                    <section class="banner-btn">
                        <button class="tt-banner-btn">Let's discuss your idea</button>
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec">
                <h2> Native-like experience available on any device</h2>
                <p>
                    At SSED, we've been providing cross-platform mobile application services for 13+ years. Out team build enterprise and consumer apps that deliver stellar performance across platforms and devices. We use our technical know-hows to bring the benefits of cross-platform app development to the table, including lower development costs, faster time to market and maximum reach.
                </p>
            </div>  
        </section>
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec-2">
                <h2> <span class="mb-orange">Cross-platform apps development,</span> <br> from idea to launch and more</h2>
            </div>
        </section>
        <section class="mb-container mb-container-padding">
            ...
            <section class="banner-btn">
                ...
                <section class="mb-container sec-3">
                    <div class="delievery-industry-spec">
                        <h2> Cross-platform mobile development
                            for any industry</h2>
                        <p>
                            Aiming to hit the market with a cutting-edge product or looking to remove operational bottlenecks for better business efficiency? No matter what your goal is, our cross-platform developers with industry-specific experience will help you get there.</p>
                    </div>  
                </section>
        <section class="mb-container sec-3">
        <section class="mb-container mb-container-padding">
                        ...
                        <div class="mb-icon-text-col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="34" viewBox="0 0 54 34" fill="none">
                                <g clip-path="url(#clip0_199_4983)">
                                    <path
                                        d="M34.9093 0.879883V10.7621L24.7062 16.0673V9.75136L12.5625 16.0673V33.8799H41.0626V0.879883H34.9093ZM24.3833 28.8823H17.42V22.6841H24.381L24.3833 28.8823ZM36.2047 28.8823H29.2442V22.6841H36.2052L36.2047 28.8823Z"
                                        fill="#FFDB3B" />
                                </g>
                                <defs>
                        ...
                        <div class="mb-icon-text-col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="34" viewBox="0 0 54 34" fill="none">
                                <g clip-path="url(#clip0_199_5005)">
                                    <path
                                        d="M27.9668 10.6234L35.9165 2.6579L34.1976 0.879883L27.0358 7.99195L19.8024 0.879883L18.0836 2.6579L26.1764 10.6234H13.5V33.8799H40.5V10.6234H27.9668ZM28.8979 25.8433L25.0305 22.0027L19.8024 27.1945L18.1552 25.5588L25.1021 18.6601L28.9695 22.5006L34.2692 17.2376L35.9165 18.8734L28.8979 25.8433Z"
                                        fill="#FFDB3B" />
                                </g>
                                <defs>
                        ...
                        <div class="mb-icon-text-col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="34" viewBox="0 0 54 34" fill="none">
                                <g clip-path="url(#clip0_199_5040)">
                                    <path
                                        d="M26.8188 28.5912C31.78 28.5912 35.8018 27.5999 35.8018 26.3771C35.8018 25.1543 31.78 24.1631 26.8188 24.1631C21.8577 24.1631 17.8359 25.1543 17.8359 26.3771C17.8359 27.5999 21.8577 28.5912 26.8188 28.5912Z"
                                        fill="#FFDB3B" />
                                    <path
                                        d="M26.819 22.4181C31.7172 22.4181 35.6878 18.4474 35.6878 13.5492C35.6878 7.21527 26.819 0.879883 26.819 0.879883C26.819 0.879883 17.9502 7.21527 17.9502 13.5492C17.9502 18.4474 21.9208 22.4181 26.819 22.4181Z"
                                        fill="#FFDB3B" />
                                    <path
                                        d="M38.3132 20.8476C37.5465 20.5348 36.7624 20.2665 35.9648 20.0439C35.6 20.5559 35.1933 21.0366 34.7489 21.4812C34.647 21.5831 34.5427 21.6821 34.4375 21.7794C35.4914 22.0254 36.5247 22.3528 37.528 22.7586C40.0063 23.7797 41.4863 25.1324 41.4863 26.3751C41.4863 27.6179 40.0045 28.9747 37.528 29.9944C34.6831 31.1686 30.8807 31.8125 26.8195 31.8125C22.7582 31.8125 18.9557 31.1686 16.1109 29.9944C13.6325 28.9733 12.1526 27.6202 12.1526 26.378C12.1526 25.1357 13.6325 23.7806 16.1109 22.7615C17.1129 22.3558 18.1447 22.0285 19.1971 21.7822C19.0919 21.685 18.9877 21.5859 18.8858 21.484C18.4413 21.0394 18.0346 20.5587 17.6698 20.0468C16.8722 20.2693 16.0881 20.5376 15.3214 20.8504C11.9478 22.2397 10.0879 24.2033 10.0879 26.378C10.0879 28.5525 11.9478 30.5158 15.3257 31.9074C18.4123 33.1793 22.4942 33.8799 26.8195 33.8799C31.1446 33.8799 35.2265 33.1793 38.3132 31.9074C41.6911 30.5148 43.551 28.5511 43.551 26.378C43.551 24.2048 41.6911 22.2397 38.3132 20.8476Z"
                                        fill="#FFDB3B" />
                                </g>
                                <defs>
        ...
        <section class="mb-container sec-3">
            <div class="delievery-industry-spec-2">
                <h2> <span class="mb-orange">Leveraging the power of emerging tech</span> <br> for cross-platform app development</h2>
            </div>
        </section>
            ...
            <div class="mb-tab">
                ...
                <button class="mb-tablinks mb-button" onclick="openCity(event, 'Tokyo1')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="41" viewBox="0 0 60 41" fill="none">
                        <g clip-path="url(#clip0_199_5136)">
                            <path
                                d="M47.674 15.2058V10.2237L43.342 7.73264L40.1468 9.56978L34.3316 6.21098V2.87095L29.9996 0.379883L25.6676 2.87095V6.21098L19.8525 9.56978L16.6571 7.73264L12.3252 10.2237V15.2058L16.6571 17.6969L19.8221 15.877L24.1959 18.3811V23.7168L29.9996 27.0542L35.8033 23.7168V17.0425L29.9996 13.7056L25.3363 16.387L20.9891 13.8985V11.5659L26.5441 8.35735L29.9996 10.3442L33.4552 8.35735L39.0101 11.5659V15.2058L42.1902 17.0347V23.647L39.0101 25.4757V29.1917L33.4546 32.4019L29.9996 30.415L26.5446 32.4019L20.9891 29.1917V25.4757L16.6571 22.9846L12.3252 25.4757V30.4578L16.6571 32.9489L19.7865 31.1493L25.6676 34.5478V37.8883L29.9996 40.3799L34.3316 37.8883V34.5478L40.2127 31.1493L43.342 32.9489L47.674 30.4578V25.4757L44.4939 23.647V17.0347L47.674 15.2058Z"
                                fill="#FFDB3B" />
                        </g>
                        <defs>
                            <clipPath id="clip0_199_5136">
                                <rect width="60" height="40" fill="white" transform="translate(0 0.379883)" />
                            </clipPath>
                        </defs>
                    </svg>
                    <div>IoT</div>
                ...
                <button class="mb-tablinks mb-button" onclick="openCity(event, 'Tokyo2')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="61" height="41" viewBox="0 0 61 41" fill="none">
                        <g clip-path="url(#clip0_199_5142)">
                            <path
                                d="M44.5163 29.6475C44.5167 29.4958 44.4871 29.3455 44.429 29.2053C44.371 29.0653 44.2857 28.9378 44.1781 28.8306C44.0705 28.7234 43.9427 28.6384 43.802 28.5806C43.6612 28.5227 43.5105 28.4932 43.3583 28.4936H31.7176V24.3843H42.412C46.3631 24.3843 49.5839 21.1749 49.5839 17.2381C49.5839 13.3013 46.3631 10.0953 42.412 10.0953C41.9794 10.0936 41.5476 10.1365 41.1238 10.2233C40.7803 4.70076 36.1841 0.379883 30.6026 0.379883C25.6209 0.379883 21.4554 3.84637 20.3388 8.46725C20.0812 8.46725 19.8662 8.42439 19.6087 8.42439C15.1426 8.42329 11.5352 12.0178 11.5352 16.4239C11.5352 20.8299 15.1426 24.4254 19.5657 24.4254H29.4015V28.5332H17.7189C17.5667 28.5328 17.4159 28.5623 17.2752 28.6201C17.1346 28.6779 17.0067 28.7629 16.8991 28.8701C16.7915 28.9773 16.7062 29.1048 16.6482 29.245C16.5901 29.3852 16.5605 29.5354 16.5609 29.687V34.1711H13.5424L17.6847 40.3799L21.8276 34.1711H18.7948V30.8458H29.3569V34.1711H26.3168L30.4597 40.3799L34.6021 34.1711H31.5902V30.8458H42.1545V34.1711H39.2319L43.3749 40.3799L47.5177 34.1711H44.5163V29.6475Z"
                                fill="#FFDB3B" />
                        </g>
                        <defs>
                            <clipPath id="clip0_199_5142">
                                <rect width="60" height="40" fill="white" transform="translate(0.55957 0.379883)" />
                            </clipPath>
                        </defs>
                    </svg>
                    <div>Cloud</div>
