            ...
            <div class="mb-sec-2-inner">
                ...
                <div class="mb-row mb-sec-2-2">
                    ...
                    <div class="mb-sec-2-inner-col">
                        ...
                        <p class="sec-2-device-p">
                            Dynamically updating content with no page refreshing, SPAs are a superb way to provide a
                            faster and simple experience to users. Build your SPA with us
                        </p>
                    ...
                    <div class="mb-sec-2-inner-col">
                        ...
                        <p class="sec-2-device-p">
                            Get excellent scalability, improve your web app performance, and cut project costs by
                            placing the underlying infrastructure in the cloud
                        </p>
