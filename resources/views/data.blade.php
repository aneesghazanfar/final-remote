...
<body id="page-index">
    ...
    <div class="body-wrap-1">
            ...
            <div class="mb-sec-2-inner">
                <div class="mb-sec-2-inner">
                    <h2 class="mb-text-white">Making business sense of your data for any user,
                        anytime, anywhere</h2>
                    <p>
                        Are you overwhelmed by your data flood, not sure where to turn? Our big data consultants
                        decipher
                        your data, turn chaos into clarity, and provide insights everyone in your team can grasp.
                    </p>
                    <div class="mb-row mb-sec-2-2">
                        <div class="mb-sec-2-inner-col">
                            ...
                            <p class="sec-2-device-p">
                                Build a lightweight and platform-agnostic PWA in its latest iteration or revamp your
                                existing web app into a PWA for impressive performance
                            </p>
        ...
        <section class="mb-sec-2 mb-container">
            <div class="mb-sec-2-inner">
                <p>
                    We develop consumer and enterprise apps of any complexity that can handle
                    a rapidly growing user base. Many of our clients’ products have expanded from
                    an MVP to a full-featured app with millions of users.
                </p>
                <div class="mb-row mb-sec-2-2">
                    <div class="mb-sec-2-inner-col">
