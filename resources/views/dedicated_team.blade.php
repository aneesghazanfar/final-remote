            ...
            <div class="delievery-industry-spec">
                ...
                <p>
                    With a “hungry for challenges” mentality, we root for your product’s success.
                     Dedicated development teams from  SSEDLAB make you feel like you’ve worked with them for ages. You get motivated specialists
...
<section class="mb-sec-2 mb-container">
        ...
        <section class="mb-sec-2 mb-mt-50">
            <div class="accordian-container">
                ...
                <button class="accordion">Project-based</button>
                <div class="panel">
                    <p>If you have well-defined requirements and clearly outlined deliverables, you will benefit from project-based cooperation. With a fixed scope, quality metrics, and delivery schedule, you will be charged a fixed amount once project milestones are handed off.
.</p>
                </div>
